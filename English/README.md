...
>
> 由一个独立的元音或者一个元音加上一个或多个辅音构成的。
>
> 因为读音比较响亮，因此可以和其他的辅音构成一个音节
>
...
| -------------------------------------- | ---------------------------------- |
| at\|on                                 | 在...地点\|里面                    |
| on\|above\|over\|under\|below\|baneath | 在...上面\|下面                    |
| in front of\|behind                    | 在...之前\|之后                    |
| near\|by\|beside\|next to              | 在...附近\|旁边                    |
| between\|among                         | 在...之间(among表三者及以上的之间) |
| around                                 | 在...周围                          |
| into\|out of                           | 进入...里面\|从...里出去           |
| onto\|off                              | 到...上面\|脱离                    |
...
> 强调句构成: **It is|was ... that|who...**
>
> 即 将普通句子拆分成两部分, 把要强调的部分放在 It is ... that 中间, 注: **不能强调形容词和动词**
>
> 示例: 
>
> We hear the more honest argument only in recent years.(原句)
>
> It is <u>only in recent years</u> thar we hear the more honest argument.(强调句)
>
> **区分形式主语从句和强调句: **
>
> - 去掉It is ... that, 余下的成分可还原成一个完整的句子, 即为强调句, 否则是形式主语从句
> - 若It is ... that 中间是形容词后动词, 则为主语从句, 因为强调句不能强调形容词和动词
...
> - **方式状语从句: 按照...方式, 如同...**
>
> as 不管表达那种含义, 只要引导的是完整的句子, 那就一定是状语从句
...
>
> 引导词: **if, unless(除非...), provided(提供...), as long as(同so long as, 表只要...), in case(倘若...), once(一旦...)**
>
> 示例: 
>
...
> 原因状语从句: 作为原因补充说明主句
>
> 引导词: **because(因为...), since(既然... 此处的since不指时间), as(因为...此处as表原因), now that(既然,...由于)**
>
...
>
> 引导词: **so that(若有形容词, 要放在so之后, 有so修饰, that展现结果), so that, such that(都表示太...所以**
>
> 示例: 
>
