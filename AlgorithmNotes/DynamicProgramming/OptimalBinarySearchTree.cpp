...
void printOptimalBST(int i, int j, int r) {
    ...
    if (rootChild == root[1][n]) {
        //输出整棵树的根
        cout << "k" << rootChild << "is a root" << endl;
    ...
    {
        if (j < r) {
            cout << "d" << j << " is " << "k" << r << " left child " << endl;
        } else
    ...
    {
        if (rootChild < r) {
            cout << "k" << rootChild << " is " << "k" << r << " left child " << endl;
        } else
            cout << "k" << rootChild << " is " << "k" << r << " right child " << endl;
    }
...
int main() {
    optimalBST(p, q, n);
    printRoot();
    cout << "optimal binary tree struct: " << endl;
